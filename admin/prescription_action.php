<?php
    ...
    if(isset($_POST['add_prescription']))
    {
        ...
        $medicine = $_POST['medicine_note'];
        $advice = $_POST['advice_note'];

        $sql = "INSERT INTO prescription (date,patient_id,doc_id,medicine,advice) VALUES ('$date','$patient','$doctor','$medicine','$advice')";
    ...
    if(isset($_POST['update_prescription']))
    {
        ...
        $sql = "UPDATE prescription set date='$date',patient_id='$patient_id',doc_id='$doctor_id',medicine='$medicine',advice='$advice' WHERE id='$id' ";
        $query_run = mysqli_query($conn,$sql);
