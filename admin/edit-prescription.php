                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off" name="date" class="form-control" id="presdate" value="<?=$user['date'];?>" required onkeypress="return false;">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="summernote" id="edit_medicine" name="medicine_note"><?php echo $user['medicine'];?>
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
