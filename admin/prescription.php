                  ...
                  <div class="card-body">
                      <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                          <?php
                            $i = 1;
                            $sql = "SELECT CONCAT(pat.fname,' ',pat.lname) as pname,doc.name,pres.medicine,pres.date,pres.id FROM prescription pres JOIN tblpatient pat ON pat.id = pres.patient_id JOIN tbldoctor doc ON doc.id = pres.doc_id";
