                ...
                <div class="card-body">
                  <table id="example1" class="table table-borderless table-hover" style="width:100%;">
                    ...
                    <tbody><?php
                        ...
                        <td><img src="../upload/doctors/<?= $row['image']?>" class="img-thumbnail img-circle" width="50" alt=""></td>
                        ...
                        <td>
                          <button data-id="<?php echo $row['id']; ?>" class="btn btn-sm btn-secondary viewDentistbtn"><i class="fa fa-eye"></i></button>
                          <button data-id="<?php echo $row['id']; ?>" class="btn btn-sm btn-info editDentistbtn"><i class="fas fa-edit"></i></button>
                          <input type="hidden" name="del_image" value="<?php echo $row['image'];?>">
                          <button data-id="<?php echo $row['id']; ?>" class="btn btn-danger btn-sm deleteDentistbtn"><i class="far fa-trash-alt"></i></button>
                        </td>
                        </tr>
                        <?php
                        }
