                     ...
                     <div class="card-body">
                        <div class="tab-content">
                           <div class="active tab-pane" id="appointment">                           
                              ...
                              <h5 class="text-info"><i class="icon fas fa-info"></i> Reminder</h5>
                              <p>Due to COVID-19 pandemic we are strictly by appointment only until further notice.
                                ...
                                Wearing a face mask is a must to ensure the safety of Doctors and Patients.</p>
                            </div>
                              <!-- Post -->
                              <a class="btn btn-outline-primary" href="request_appointment.php">
