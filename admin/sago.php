    ...
    <div class="modal-content">
      ...
      <form action="doctor_action.php" id="doctor_form" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="submit_button" name="insertdoctor" class="btn btn-info">Submit</button>
        </div>
      </form>
    </div>
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="doctor_action.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 auto">
              <div class="form-group">
                <label>Confirm Password</label>
                <span class="text-danger">*</span>
                <input type="password" id="edit_confirmPassword" name="confirmPassword" class="form-control" placeholder="password" required>
              </div>             
            </div>
          </div>
          <div class="row">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="submit" name="updatedoctor" class="btn btn-info">Submit</button>
        </div>
      </form>
    </div>
  </div>
